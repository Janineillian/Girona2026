...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[boxrule=0pt, colback={codebgcolor}, sharp corners, frame hidden, breakable, enhanced]}{\end{tcolorbox}}\fi
\makeatother
\usepackage{bookmark}
