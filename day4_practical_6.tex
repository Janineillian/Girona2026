...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[sharp corners, boxrule=0pt, enhanced, colback={codebgcolor}, breakable, frame hidden]}{\end{tcolorbox}}\fi
\makeatother
\usepackage{bookmark}
...
\begin{tcolorbox}[enhanced jigsaw, breakable, leftrule=.75mm, left=2mm, toptitle=1mm, title={Task}, bottomrule=.15mm, opacityback=0, toprule=.15mm, colframe=quarto-callout-warning-color-frame, rightrule=.15mm, colback=white, titlerule=0mm, arc=.35mm, colbacktitle=quarto-callout-warning-color!10!white, bottomtitle=1mm, coltitle=black, opacitybacktitle=0.6]
...
\begin{tcolorbox}[enhanced jigsaw, breakable, leftrule=.75mm, left=2mm, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, bottomrule=.15mm, opacityback=0, toprule=.15mm, colframe=quarto-callout-note-color-frame, rightrule=.15mm, colback=white, titlerule=0mm, arc=.35mm, colbacktitle=quarto-callout-note-color!10!white, bottomtitle=1mm, coltitle=black, opacitybacktitle=0.6]
...
\begin{tcolorbox}[enhanced jigsaw, breakable, leftrule=.75mm, left=2mm, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Posterior predictive model checking}, bottomrule=.15mm, opacityback=0, toprule=.15mm, colframe=quarto-callout-note-color-frame, rightrule=.15mm, colback=white, titlerule=0mm, arc=.35mm, colbacktitle=quarto-callout-note-color!10!white, bottomtitle=1mm, coltitle=black, opacitybacktitle=0.6]
